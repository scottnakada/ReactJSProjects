...
var routes = (
    ...
    <Route name="app" path="/" handler={require('./components/App/App')}>
        ...
        <DefaultRoute handler={require('./components/LandingPage/LandingPage')}/>
        /* /landing will load the landing page */
        <Route name="landing" handler={require('./components/LandingPage/LandingPage')}/>
        /* /signup will load the signup page */
        <Route name="signup" handler={require('./components/Signup/Signup')}/>
        /* /thank-you will load the thank-you page */
        <Route name="thank-you" handler={require('./components/ThankYou/ThankYou')}/>
